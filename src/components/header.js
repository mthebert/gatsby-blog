    ...
    render = { data => (
        <header className={styles.container}>
            <div className={styles.row}>
                ...
                <SocialButton site="github" username="mthebert"></SocialButton>
                <SocialButton site="linkedin" username="mthebert"></SocialButton>
                <SocialButton site="twitter" username="matt_thebert"></SocialButton>
            </div>
